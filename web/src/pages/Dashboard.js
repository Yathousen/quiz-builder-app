...
const Dashboard = () => {
  ...
  return (
    <div className='flex justify-center content-center align-middle w-full min-h-screen pb-8 bg-slate-200'>
      <div className='flex flex-col w-11/12 md:w-8/12 min-h-screen pb-8 md:h-fit mx-auto overflow-hidden mt-10'>
        <Breadcrumbs />
        ...
        <div className='flex w-11/12 md:w-8/12 mx-auto overflow-hidden bg-white rounded-lg shadow-sm mt-6 content-center justify-center p-8'>
          <div className='flex flex-col items-center -mx-2'>
            <img className='object-cover w-24 h-24 mx-2 rounded-full' src={session.photoURL} alt='avatar' />
        ...
        <div className='mt-6 w-11/12 md:w-8/12 mx-auto flex justify-between'>
        ...
        <div className='mt-6 w-11/12 md:w-8/12 mx-auto'>
          {loading ? (
            ...
            quizzes.map((q) => <QuizItem data={q} />)
          ) : (
            <div className='flex flex-col w-full mx-auto overflow-hidden bg-white rounded-lg shadow-sm mt-6 content-center justify-center p-8'>
              <p className='py-20 text-2xl font-bold text-center text-slate-400'>No quizzes have been created</p>
            </div>
          )}
        </div>
      </div>
